...
public class EquipoAFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        db.collection(FirebaseVar.USUARIOS).document(auth.getUid()).collection(FirebaseVar.EQUIPOS).document(viewmodel.idEquipoLocal).collection(FirebaseVar.JUGADORES).addSnapshotListener((value, error) -> {
