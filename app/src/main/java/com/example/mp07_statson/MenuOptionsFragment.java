...
import com.example.mp07_statson.databinding.FragmentMenuOptionsBinding;
...
public class MenuOptionsFragment extends Fragment {
    ...
    private FragmentMenuOptionsBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentMenuOptionsBinding.inflate(inflater, container, false)).getRoot();
    }
